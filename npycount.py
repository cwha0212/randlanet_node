...
import numpy as np
# 포인트 클라우드 파일 경로 설정
velodyne_path = "/media/chang/jairlab_ssd/DATA/lidar_data/ENG_AND_JBNU/label_data_0.06/09/velodyne/"
# 라벨 파일 경로 설정
label_path = "/media/chang/jairlab_ssd/DATA/lidar_data/ENG_AND_JBNU/label_data_0.06/09/labels/"
