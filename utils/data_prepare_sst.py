...
data_config = os.path.join(BASE_DIR, 'sst.yaml')
...
grid_size = 0.06
dataset_path = '/media/chang/jairlab_ssd/DATA/lidar_data/ENG_AND_JBNU/label_data'
output_path = '/media/chang/jairlab_ssd/DATA/lidar_data/ENG_AND_JBNU/label_data1' + '_' + str(grid_size)
